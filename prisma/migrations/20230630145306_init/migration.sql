...
CREATE TABLE "Note" (
    ...
    CONSTRAINT "Note_imageId_fkey" FOREIGN KEY ("imageId") REFERENCES "Image" ("fileId") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE "Keywords" (
    ...
    CONSTRAINT "Keywords_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "Note" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Note_imageId_key" ON "Note"("imageId");
